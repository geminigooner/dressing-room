...
export function buildStructuredEditPlan({
  ...
  if (hasOutfitReference) {
    instructionClauses.push(
      `Dress the subject in Image 1 (Base Photo) in the exact clothing shown in Image 2 (Outfit Reference), matching its cut, fabric texture, and color palette accurately to their body shape. Additional user styling instructions: ${originalRequest}.`
    );
  } else {
